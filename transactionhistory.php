...
<head>
    ...
    <link href="Customerdata.css" rel="stylesheet">
...
$records = mysqli_query($con,"SELECT * FROM `customer_list`.`transaction_history`") or die( mysqli_error($con));// fetch data from database
...
?>
  <tr>
    ...
    <td><?php echo $data['amount transferred']; ?></td>
